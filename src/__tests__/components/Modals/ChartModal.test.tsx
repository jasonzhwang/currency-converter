...
describe("ChartModal", () => {
  ...
  describe("Loading and Empty States", () => {
    ...
    test("shows loading state with empty chart data", () => {
      render(
        <ChartModal
          isOpen
          baseCurrency="AUD"
    ...
    test("handles transition from loading to empty", () => {
  ...
  describe("Chart Display", () => {
    ...
    test("displays different currency pairs correctly", () => {
      const { rerender } = render(
        <ChartModal
          isOpen
          baseCurrency="AUD"
  ...
  describe("Edge Cases", () => {
    test("handles empty currency strings", () => {
      render(
        <ChartModal
          isOpen
          baseCurrency=""
    ...
    test("handles very large currency code strings", () => {
      render(
        <ChartModal
          isOpen
          baseCurrency="AUUUUUUD"
          targetCurrency="USSSSSD"
          chartData={sampleData}
          isLoading={false}
          onClose={() => {}}
        />
    ...
    test("handles same base and target currency", () => {
      render(
        <ChartModal
          isOpen
          baseCurrency="AUD"
      ...
      expect(screen.getByText(/AUD \/ AUD/)).toBeInTheDocument();
    });
  });
});
